...
function IndexPage() {
  ...
  return (
    <main className={`min-w-screen min-h-screen font-mono p-4 theme-${theme}`}>
      ...
      <p className="mb-4">
        ...
        <a href="http://notion.so/">Notion</a>. Click on any icon or its name to
        copy a link to to the image asset.
      </p>
